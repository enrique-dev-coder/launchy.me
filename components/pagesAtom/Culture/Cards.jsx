...
const Cards = () => {
  return (
    <div className='px-[2%] lg:px-0 mt-[60px] md:mt-[80px] max-w-[640px] lg:max-w-[906px] mx-auto'>

        <h2 className='text-white text-center text-lg lg:text-[22px] tracking-[.125rem] ld:tracking-widest mb-[40px] md:mb-[60px] font-roboto'>Apostamos por ser especialistas en diversas areas para formar equipos multidisciplinarios que aporten mas valor</h2>

        <div className="flex items-center overflow-x-auto scrollbar py-[1rem] lg:grid lg:grid-cols-3 gap-4">
            {
            aliens.map(alien => (
                <Card 
                    alien={alien.name}
