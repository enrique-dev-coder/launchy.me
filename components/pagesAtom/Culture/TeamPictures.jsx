    ...
    <Fragment>
        ...
        <div className="grid grid-cols-3 gap-4 px-[2%]">
            ...
            <div className="grid col-span-1 grid-cols-2 gap-4">
                ...
                <div className="col-span-2 bg-slate-500 h-[200px] relative z-30"></div>
            ...
            <div className="grid col-span-1 grid-cols-2 gap-4">
                ...
                <img src='/img/team fotos/Luis cumple (7).png' alt="" className='col-span-1 relative z-30' />

                <img src='/img/team fotos/Tite (9).png' alt="" className='col-span-1 relative z-30' />

                <img src='/img/team fotos/Team Launchy (8).png' alt="" className='col-span-2 relative z-30' />
