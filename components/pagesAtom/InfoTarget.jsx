...
const InfoTarget = ({ objetivoTexto, desafioTexto, imgData }) => {
  ...
  return (
    <FadeInElement>
      <div className="mb-[60px] md:mb-[80px] pt-[30px] md:pt-[40px] px-[8%] max-w-[1440px] mx-auto">
        ...
        <div className="mb-[60px] md:mb-[80px]">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-between">
            {/* First Square */}
            <div
              className={`flex flex-col gap-6 w-full md:w-1/4 border border-black p-8 bg-gradient-to-t ${color} rounded-lg`}
            >
            ...
            {/* Second Square */}
            <div
              className={`flex flex-col gap-2 w-full md:w-1/4 border border-black p-8 bg-gradient-to-t ${color} rounded-lg`}
            >
            ...
            >
              <div
                className={`w-[${width.three}px] h-[${height.three}px] mb-4`}
              >
                <Image
                  src={imgURL.three}
                  width={width.three}
