  ...
  return (
    <HomeSectionContainer>
      <div className="w-full h-full" id="free-resources">
        ...
        <div>
          <h2 className="text-black uppercase  text-center mb-[30px] md:mb-[40px] roboto_condesed flex flex-col md:flex-row  justify-between text-[40px] md:text-[105px]  resource_text">
