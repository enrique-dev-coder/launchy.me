...
const texts = [
  ...
  {p: 'Launchy está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no autorizado.'},
  {h2: 'cookies'},
  ...
  {p: 'Launchy se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.'}
]
    ...
    <main className="2xl:container 2xl:mx-auto">
            <StarBackgroundCss>
                ...
                <div className="flex flex-col my-20 pt-14 pb-20 border-b">
                  ...
                  <h2 className='text-white text-center text-4xl tracking-wider uppercase mt-5'>Politicas de privacidad | CO</h2>
                ...
                <div className="px-[8%] my-[30px]">
                {
                  texts.map(text => text.h2? 
                  <h2 className='text-white text-xl font-bold mt-[60px] uppercase'>{text.h2}</h2> 
