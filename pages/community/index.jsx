...
//Solution text
const solutionText =
  'Decidimos trabajar con bloques debido a la iteración del proyecto y lo variante que ha sido acorde al descubrimiento de uevas aplicaciones así como también nuevas iniciativas a partir de la primera.';
    ...
    <main className="bg-[#F1F1F1] 2xl:container 2xl:mx-auto">
      ...
      <FadeInElement>
        <div className="mb-[30px] md:mb-[40px] px-[8%]">
          ...
          ofrecer una guía en la distribución de información, logrando reducirla
          a un 60% de la original que iba a ser publicada.
        </div>
      ...
      <FadeInElement>
        <div className="mb-[30px] md:mb-[40px] px-[8%]">
          Trabajamos en conjunto con el equipo técnico para ir solucionando las
          necesidades que fue presentando el proyecto conforme va avanzando en
          cuanto a la construcción de la documentación así como los pilotos
          técnicos.
        </div>
